                    ...
                    <div class="col-sm-12">
                        <div class="gb groom">
                            ...
                            <div class="details">
                                <div class="details-inner">
                                    <h3>The groom</h3>
                                    <p>Hi I am Krishna , dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                                    <span class="signature">Krishna</span>
                        ...
                        <div class="gb bride">
                            <div class="details">
                                <div class="details-inner">
                                    <h3>The Bride</h3>
                                    <p>Hi I am Radha, dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                                    <span class="signature">Radha</span>
                                    <ul class="social-links">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-pinterest"></i></a></li>
                ...
                <div class="row content">
                    <div class="col-sm-12">
                        ...
                        <form id="rsvp-form" class="form validate-rsvp-form row" method="post">
							<?php echo do_shortcode( '[contact-form-7 id="5" title="wedding"]' ); ?>
                        </form>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
